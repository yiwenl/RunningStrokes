...
void main(void) {
	...
	gl_FragColor += texture2D(texture, vTextureCoord 	  )*0.159576912161 * (1.0 + selfOffset);
	...
	gl_FragColor += texture2D(texture, v_blurTexCoords[13])*0.00442991210551132;
